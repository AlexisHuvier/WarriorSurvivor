...
public class MainMenu: SharpEngine.Scene
{
    public MainMenu()
    {
        ...
        AddWidget(new Button(new Vec2(600, 350), "Jouer", "small", new Vec2(250, 50))).Command =
            _ => GetWindow().IndexCurrentScene = 2;
        AddWidget(new Button(new Vec2(600, 450), "Supprimer Données", "small", new Vec2(250, 50))).Command =
            _ => WS.SaveManager.Reset();
        AddWidget(new Button(new Vec2(600, 550), "Options", "small", new Vec2(250, 50)));
        AddWidget(new Button(new Vec2(600, 650), "Quitter", "small", new Vec2(250, 50))).Command =
            _ => GetWindow().Stop();
