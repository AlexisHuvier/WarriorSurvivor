...
public class PlayerDisplayer: SharpEngine.Widgets.Widget
{
    ...
    public void UpdateInformation()
    {
        ...
        AddChild(new Label(new Vec2(0, -175), $"Vie : {WS.PlayerData.Stats.Life}", "medium"));
        AddChild(new Label(new Vec2(0, -125), $"Vitesse : {WS.PlayerData.Stats.Speed}", "medium"));
        AddChild(new Label(new Vec2(0, -75), $"Attaque : {WS.PlayerData.Stats.Attack}", "medium"));
